...
// Check if the user is logged in and retrieve the customer_id from the session
session_start();

if (isset($_SESSION['customer_id'])) {
    $customer_id = $_SESSION['customer_id'];

    // Call the function with the user's identifier
    get_userorder_details($customer_id);
} else {
