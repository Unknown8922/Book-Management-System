...
<div class="container" style="width: 500px; margin-top:20px";>
	<div class="card">
       <img src="../images/suppregg.png" class="card-img-top" width="100px" height="300px">
		<div class="card-body">

	<form class="form-group" action="suppliervalidate.php" method="post">

		<center><h3> Supplier Sign Up</h3></center><br>
		...
		<center>
		<input type="submit" name="suppregister"  class="btn btn-primary" value="Register" style="background-color: #537895; color: white; border-color: #09203F;">	
		</center>
