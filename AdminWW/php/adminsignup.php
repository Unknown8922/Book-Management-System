	...
	<style>
        ...
        .container-footer {
            ...
            padding: 0 15px;
					...
					<div class="container">
					<a href="signup.php" class="btn btn-danger" style="background-color: #09203F; color: white; border-color: wheat;">User Sign Up</a>
...
<div class="container" style="width: 500px; margin-top:20px";>
	<div class="card">
       <img src="../images/adminsignupp.png" class="card-img-top" width="100px" height="300px">
		<div class="card-body">

	<form class="form-group" action="adminsignup_process.php" method="post">

		<center><h3> Admin Sign Up</h3></center><br>
		...
		<center>
		<input type="submit" name="adminregister"  class="btn btn-primary" value="Register" style="background-color: #537895; color: white; border-color: #09203F;">	
		</center>
