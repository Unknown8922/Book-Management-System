...
<div class="container" style="margin-top: 20px;">
 ...
 <div class="col-md-5">
        ...
        <div class="card">
            <img src="../images/viewbooks.png" class="card-img-top" height="250px" width="200px">
            <div class="card-body">
                <center><h3> View Books</h3></center><br>
	
	<form class="form-group" action="viewbooks.php" method="post">
	...
	if ($conn->connect_error) {
		...
		<center>
		<input type="submit" name="submit"  class="btn btn-danger" value="View Book" style="background-color: #09203F; color: white; border-color: #09203F;">	
		</center>
