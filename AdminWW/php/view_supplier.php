...
<body>
    <style>
        ...
        footer {
            ...
            color: #fff;
            padding: 80px 0;
            margin-top: 310px; /* Increase this value to move the footer down further */
    ...
    <div class="container" style="width: 1500px; margin-top:100px";>
        <div class="card">
            <div class="card-body" style="background-color: #537895; color: white; border-color: #06F2F8;"><h3 align="center">
                <div class="row">
                    <div class="col-md-3">
                        <a href="userpanel.php" class="btn btn-light">Click to go back</a>
                    </div>
                    <div class="col-md-4">
                        <h4> Dubai Books Supplier Details</h4>
                    </div>
                    <div class="col-md-5">
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">WSDLURL Of Supplier</th>
                            
                        </tr>
                    </thead>
                    <tbody>
                        <?php 
                            // This is where the function call is now located
                            view_suppliers();  
                        ?>
                    </tbody>
                </table>
