...
<div class="container-fluid">
    <?php
    //session_start();
    require('supplierlogin_process.php'); 
    ...
    <h1 style="color: white;">WELCOME <?php echo $username; ?> </h1>
           ...
           <div class="row">
				...
				<div class="list-group">
					<class="list-group-item active" style="background-color: #537895; color: white; border-color: #06F2F8;"><h3 align="center">Supplier Operations</h3>
