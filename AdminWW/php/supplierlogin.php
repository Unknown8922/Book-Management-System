...
<div class="container">
					...
					<a href="adminlogin.php" class="btn btn-danger" style="background-color: #09203F; color: white; border-color: wheat;">Admin Login</a>
...
<div class="container" style="width: 400px; margin-top:50px";>
	<div class="card">
       <img src="../images/supplierlogin.png" class="card-img-top" width="100px" height="300px">
		<div class="card-body">

			<center><h3> Supplier Login</h3></center><br>

	<form class="form-group" action="supplierlogin_process.php" method="post">
