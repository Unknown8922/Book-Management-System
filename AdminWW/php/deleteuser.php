...
if(isset($_POST['delete'])) {
    ...
    // Delete the users record from the database
...
<div class="container" style="width: 1500px; margin-top:100px";>
    ...
    <div class="container">
        ...
        <form method="POST">
            ...
            <button type="submit" class="btn btn-danger" name="delete" style="background-color:#09203F; border-color:#09203F;">Delete</button>
        </form>
    </div>
    </div>
