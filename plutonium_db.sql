...
(3, 'Best Mobile', 'Best Mobile App Book', 'Abdurrahman', 3000, 'Technology', 'available'),
(4, 'IOT based app', 'Artificial intelligence included', 'Maihula', 500, 'technology', 'available');
